...
Vetev* TypVetve::VytvorNovouVetevDleTypu(Vetev puvodniVetev, int typVetve, int posun, int velikost)
{
	...
	switch (typVetve){
		case 1 :
			novaVetev = new Vetev(puvodniVetev._xKonec, puvodniVetev._yKonec + posun, puvodniVetev._xKonec + velikost, puvodniVetev._yKonec - velikost + posun, 'B');
			break;
		case 2: 
		...
		case 3:
			...
			break;
		case 4:
			novaVetev = new Vetev(puvodniVetev._xKonec, puvodniVetev._yKonec + posun, puvodniVetev._xKonec - velikost, puvodniVetev._yKonec - velikost + posun, 'E');
			break;
		case 5:
